...
public class ServerIwill2AboutBox extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(serveriwill2.ServerIwill2App.class).getContext().getResourceMap(ServerIwill2AboutBox.class);
        setTitle(resourceMap.getString("title")); // NOI18N
        setModal(true);
        setName("aboutBox"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(serveriwill2.ServerIwill2App.class).getContext().getActionMap(ServerIwill2AboutBox.class, this);
