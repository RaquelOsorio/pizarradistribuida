...
public interface MInterfaceUsuario extends Remote {
    public int[] GuardarUsuario(VOUsuario usu)  throws RemoteException; // usado en login e ingresar usuario
    ...
    public VOUsuario ObtenerUsuario(String nu, String p) throws RemoteException;// usado en login
